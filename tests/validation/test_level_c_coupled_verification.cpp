...
int main(){try{
 ...
 Field<double,Location::CELL> T(1,"T","K",1),src(1,"src","W/m3",1),G(1,"G","W/m2",1);T(0)=800;src(0)=0;G(0)=0;ScalarBoundaryConditions tbc;tbc["wall"]={ScalarBoundaryType::FIXED_VALUE,800,0};
