    ...
    const cfdx::core::Field<double, cfdx::core::Location::CELL>& p)
{
    ...
    case IncompressibleProbeField::U_X: return U.component_data(0)[nearest];
    case IncompressibleProbeField::U_Y: return U.component_data(1)[nearest];
    case IncompressibleProbeField::U_Z: return U.component_data(2)[nearest];
