...
struct PrecisionPolicy{SolverPrecision operator_precision=SolverPrecision::FP32;SolverPrecision reduction_precision=SolverPrecision::FP64;double residual_refresh_factor=10.0;std::size_t refresh_interval=20;bool enabled=false;};
